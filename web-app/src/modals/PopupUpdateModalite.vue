...
const newModalite = ref(props.currentModalite)

const handleConfirm = () => {
  if (!newModalite.value.trim()) return
  emit('confirm', newModalite.value.trim())
}
</script>
